...
1. **`creative-director`** — gate **CD-PHASE-GATE** (`docs/studio/director-gates.md`)
2. **`technical-director`** — gate **TD-PHASE-GATE** (`docs/studio/director-gates.md`)
3. **`producer`** — gate **PR-PHASE-GATE** (`docs/studio/director-gates.md`)
4. **`art-director`** — gate **AD-PHASE-GATE** (`docs/studio/director-gates.md`)
