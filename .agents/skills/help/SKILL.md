...
Read `docs/studio/workflow-catalog.yaml`. This is the authoritative list of all
...
After reading the catalog, Glob `docs/studio/skills/*/SKILL.md` to get the full list
...
- If a step has no command (e.g. "Implement Stories"), explain what to do instead of showing a repo skill
