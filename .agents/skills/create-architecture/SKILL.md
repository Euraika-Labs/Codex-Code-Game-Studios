...
3. `docs/studio/technical-preferences.md` — naming conventions, performance budgets,
...
Apply gate **TD-ARCHITECTURE** (`docs/studio/director-gates.md`) as a self-review. Check all four criteria from that gate definition against the completed document.
