...
in this skill — apply the check pattern from `docs/studio/director-gates.md`
...
After decomposing all stories (Step 4 complete) but before presenting them for write approval, spawn `qa-lead` as a subagent using gate **QL-STORY-READY** (`docs/studio/director-gates.md`).
