...
**After dependency mapping is approved, spawn `technical-director` via Task using gate TD-SYSTEM-BOUNDARY (`docs/studio/director-gates.md`) before proceeding to priority assignment.**
...
**After priorities are approved, spawn `producer` via Task using gate PR-SCOPE (`docs/studio/director-gates.md`) before writing the index.**
...
**After the systems index is written, spawn `creative-director` via Task using gate CD-SYSTEMS (`docs/studio/director-gates.md`).**
