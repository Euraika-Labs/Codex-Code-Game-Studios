...
| File | Purpose |
|------|---------|
| `catalog.yaml` | Master registry for all 84 skills and 50 agents. Contains category, spec path, and last-test tracking fields. Always read this first when running any test command. |
...
Nothing in `docs/studio/` imports from here. Deleting this folder has no effect on the
