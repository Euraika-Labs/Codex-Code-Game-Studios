...
and world-builder in parallel). Uses `plain-text approval check` at each phase transition to
...
2. `plain-text approval check` presents the narrative brief; user approves before Phase 2 begins
...
4. `plain-text approval check` presents world foundation and dialogue drafts; user approves before Phase 3 begins
5. Phase 3: level-designer is spawned; produces environmental storytelling layout, trigger placement, and pacing plan
6. `plain-text approval check` presents level narrative plan; user approves before Phase 4 begins
...
8. `plain-text approval check` presents review results; user approves before Phase 5 begins
...
- [ ] `plain-text approval check` appears after Phase 1 output and before Phase 2 launch
- [ ] world-builder and writer Task calls are issued simultaneously in Phase 2 (not sequentially)
- [ ] level-designer is not launched until Phase 2 `plain-text approval check` is approved
...
6. `plain-text approval check` presents options:
...
- [ ] `plain-text approval check` presents at least 3 options including "stop and resolve first"
...
5. `plain-text approval check` presents options:
...
- [ ] `plain-text approval check` offers the option to fix now vs. flag and proceed
...
- [ ] `plain-text approval check` offers at least one option to resolve the missing prerequisite
