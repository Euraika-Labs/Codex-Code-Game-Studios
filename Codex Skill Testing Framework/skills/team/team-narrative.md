...
and world-builder in parallel). Uses plain-text decision prompt at each phase transition to
...
2. plain-text decision prompt presents the narrative brief; user approves before Phase 2 begins
...
4. plain-text decision prompt presents world foundation and dialogue drafts; user approves before Phase 3 begins
5. Phase 3: level-designer is spawned; produces environmental storytelling layout, trigger placement, and pacing plan
6. plain-text decision prompt presents level narrative plan; user approves before Phase 4 begins
...
8. plain-text decision prompt presents review results; user approves before Phase 5 begins
...
- [ ] plain-text decision prompt appears after Phase 1 output and before Phase 2 launch
- [ ] world-builder and writer Task calls are issued simultaneously in Phase 2 (not sequentially)
- [ ] level-designer is not launched until Phase 2 plain-text decision prompt is approved
...
6. plain-text decision prompt presents options:
...
- [ ] plain-text decision prompt presents at least 3 options including "stop and resolve first"
...
5. plain-text decision prompt presents options:
...
- [ ] plain-text decision prompt offers the option to fix now vs. flag and proceed
...
- [ ] plain-text decision prompt offers at least one option to resolve the missing prerequisite
