...
against sprint stories, and uses plain-text decision prompt to batch-verify manual smoke
...
5. Uses plain-text decision prompt for Batch 1 (core stability) and Batch 2 (sprint mechanics)
...
- [ ] plain-text decision prompt is used for manual smoke check batches
...
### Case 3: Manual Confirmation — plain-text decision prompt used, PASS WITH WARNINGS
...
3. plain-text decision prompt is used for Batch 1 and Batch 2 — developer confirms all PASS
...
**Assertions:**
- [ ] plain-text decision prompt is used for manual smoke check batches (not inline text prompts)
...
- [ ] Uses plain-text decision prompt for all manual smoke check batches (Batch 1, Batch 2, Batch 3)
...
- The `--platform` argument adds platform-specific plain-text decision prompt batches and a
