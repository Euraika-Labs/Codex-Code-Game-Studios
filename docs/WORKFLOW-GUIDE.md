# Codex Code Game Studios -- Complete Workflow Guide
...
docs/studio/templates/post-mortem.md
```
...
The project wires the supported Codex hook set it actively uses:
...
wired in `.codex/hooks.json` because those event types are not part of the
currently supported Codex hook surface.
